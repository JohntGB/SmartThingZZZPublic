	...
	tiles(scale: 2) {
		multiAttributeTile(name: "switch", type: "lighting", width: 6, height: 4, canChangeIcon: true, canChangeBackground: true) {
			tileAttribute("device.switch", key: "PRIMARY_CONTROL") {
    			attributeState "off", label: '${name}', action: "switch.on", backgroundColor: "#ffffff",icon: "https://github.com/JohntGB/SmartThingZZZPublic/tree/master/devicetypes/michaelstruck/google-switch.src/GHH-Off.png", nextState: "turningOn"
		      	attributeState "on", label: '${name}', action: "switch.off", backgroundColor: "#79b821",icon: "https://github.com/JohntGB/SmartThingZZZPublic/tree/master/devicetypes/michaelstruck/google-switch.src/GHH-On.png",  nextState: "turningOff"
				attributeState "turningOff", label: '${name}', action: "switch.on",backgroundColor: "#ffffff", icon: "https://github.com/JohntGB/SmartThingZZZPublic/tree/master/devicetypes/michaelstruck/google-switch.src/GHH-Off.png",  nextState: "turningOn"
		      	attributeState "turningOn", label: '${name}', action: "switch.off",backgroundColor: "#79b821", icon: "https://github.com/JohntGB/SmartThingZZZPublic/tree/master/devicetypes/michaelstruck/google-switch.src/GHH-On.png", nextState: "turningOff"
        	}
