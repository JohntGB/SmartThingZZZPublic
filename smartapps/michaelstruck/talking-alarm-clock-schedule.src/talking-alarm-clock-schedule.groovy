...
private alarmSoundUri(){
    ...
    switch(soundAlarm) {
    	case "1":
            ...
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmAlien.mp3", duration: "${newSoundLength}"]
        	break
        case "2":
        	newSoundLength = soundLength >0 && soundLength < 12 ? soundLength : 12
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmBell.mp3", duration: "${newSoundLength}"]
        	break
        case "3":
        	newSoundLength = soundLength >0 && soundLength < 20 ? soundLength : 20
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmBuzzer.mp3", duration: "${newSoundLength}"]
        	break
        case "4":
        	newSoundLength = soundLength >0 && soundLength < 20 ? soundLength : 20
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmFire.mp3", duration: "${newSoundLength}"]
        	break
        case "5":
        	newSoundLength = soundLength >0 && soundLength < 2 ? soundLength : 2
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmRooster.mp3", duration: "${newSoundLength}"]
        	break
        case "6":
        	newSoundLength = soundLength >0 && soundLength < 20 ? soundLength : 20
            soundUri = [uri: "https://github.com/JohntGB/SmartThingsZZZ/tree/master/Other-SmartApps/Talking-Alarm-Clock/AlarmSounds/AlarmSiren.mp3", duration: "${newSoundLength}"]
			break
		case "7":
        	newSoundLength = soundLength >0 && soundLength < 20 ? soundLength : 20
